			...
			<table>
				<tr>
					...
					<td class="text-content">
						<input type="hidden" name="functionid" value="${function.functionid}"> 
						<input type="text" name="functionname" value="${function.functionname}" 
				...
				<tr>
					...
					<td class="text-content">
						<input type="text" name="functionurl" value="${function.functionurl}"
							class="easyui-textbox theme-textbox-radius" data-options="required:true,validType:'length[2,35]'">
					</td>
				</tr>
				...
				<tr>
					...
					<td class="text-content">
						<input type="text" name="functioncode" value="${function.functioncode}"
				...
				<tr>
					...
					<td class="text-content">
						<input type="text" name="parentid" value="${function.parentid}" readonly="true"
